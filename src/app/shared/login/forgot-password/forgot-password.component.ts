  ...
  providers: [
    {
      ...
      useExisting: ForgotPasswordComponent,
      multi: true,
    },
    {
...
export class ForgotPasswordComponent implements ControlValueAccessor, Validator {
  isForgot:boolean = true;
  isConfirmOtp:boolean = false;
  isEnterNewPassword:boolean = false;
  @Output() isForgotClose : EventEmitter<boolean> = new EventEmitter(false);
  @Input()
